---
title: "Preliminaries"  James Dickens
...
#23  Use R code to write a function that calculates a weighted average if 
  # chapter exams account for 40% of your grade, homework accounts for 30% 
  # of your grade,  classwork accounts for 10% of your grade, and the final
  # exam accounts for 20% of your grade.   (WA  = .40CE + .30HW  +  .10CW + .20FE)
